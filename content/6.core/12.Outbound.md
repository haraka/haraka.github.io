...
description: How to send outbound mail with Haraka
navigation.title: Outbound
_path: /core/Outbound
---
...
* rcpt_to - an Array of `Address`<sup>[1](#fn1)</sup> objects - the rfc.5821 recipients of this mail
* mail_from - an Address<sup>[1](#fn1)</sup> object - the rfc.5821 sender of this mail
...
|------------------------|-------------|
| `dot_stuffed: true`    | Use this if you are passing your content dot-stuffed (a dot at the start of a line is doubled, like it is in SMTP conversation, see [RFC 5821][url-rfc5821].|
...
<a name="fn1">1</a>: `Address` objects are [address-rfc5821](https://github.com/haraka/node-address-rfc5821) objects.
...
[url-rfc5821]: https://tools.ietf.org/html/rfc5821
