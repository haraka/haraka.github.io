---
title: auth/auth_proxy - Authenticate users against an external service
description: Haraka auth/auth_proxy plugin - Authenticate users against an external service
navigation.title: auth/auth_proxy
---
