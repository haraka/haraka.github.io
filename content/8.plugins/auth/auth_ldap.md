---
title: auth/auth_ldap - Authenticate users against an LDAP server
description: Haraka auth/auth_ldap plugin - Authenticate users against an LDAP server
navigation.title: auth/auth_ldap
---
