---
title: queue/smtp_bridge - Deliver mail to the local MTA
description: Haraka queue/smtp_bridge plugin - Deliver mail to the local MTA
navigation.title: queue/smtp_bridge
---
