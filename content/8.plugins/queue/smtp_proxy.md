---
title: queue/smtp_proxy - Deliver mail to the proxy MTA
description: Haraka queue/smtp_proxy plugin - Deliver mail to the proxy MTA
navigation.title: queue/smtp_proxy
---

# queue/smtp_proxy plugin
