---
title: syslog - Logs to syslog plugin for Haraka
description: Haraka syslog plugin - Logs to syslog
navigation.title: syslog
---
...
fall under the DEBUG syslog level.  Note: this plugin requires modern-syslog and you need enable/add syslog inside config/plugins at the top of the file.

Configuration syslog.ini
----------------------------

This is the general configuration file for the syslog plugin.
